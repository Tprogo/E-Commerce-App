...
import com.example.e_comapplication.fragments.ExploreFragmentDirections
...
class ExploreProdAdapter (private val searchProdList: List<ProductModel>) : RecyclerView.Adapter<ExploreProdAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val prodData = searchProdList[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            val action = ExploreFragmentDirections.actionExploreFragmentToDetailInfoFragment( id = prodData.id.toLong())
...
//
        ...
        holder.removeProd.visibility = View.GONE


        holder.rating.rating = prodData.average_rating.toFloat()

        holder.regPrice.text = "₹${prodData.regular_price}"

        holder.salesPrice.text = "₹${prodData.sale_price}"
